...
public class FragmentJapanNews extends Fragment implements OnRecyclerViewItemClickListener {
    private static View rootView;
    private static final String API_KEY = "08fefe65da8140588f66354bb2145b6d";

    public  FragmentJapanNews() {
    }
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        Call<ResponseModel> call = apiService.getLatestNews("jp", API_KEY);
            ...
            public void onResponse(Call<ResponseModel> call, Response<ResponseModel> response) {
                if (response.body().getStatus().equals("ok")) {
                    ...
                    if (articleList.size() > 0) {
                        ...
                        mainArticleAdapter.setOnRecyclerViewItemClickListener(FragmentJapanNews.this);
