...
public class  FragmentIndiaNews extends Fragment implements OnRecyclerViewItemClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        addData(mainRecycler);
        return rootView;
    }
    public void addData(final RecyclerView recyclerView) {
            ...
            public void onResponse(Call<ResponseModel> call, Response<ResponseModel> response) {
                if (response.body().getStatus().equals("ok")) {
                    ...
                    if (articleList.size() > 0) {
                        ...
                        mainArticleAdapter.setOnRecyclerViewItemClickListener(FragmentIndiaNews.this);
